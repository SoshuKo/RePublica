...
`;
  ...
  const ARENA_ENEMIES = Object.freeze([
    ...
    // 追加分
    { id: "enemy_ria", name: "リア" },
    { id: "enemy_rei_member", name: "レイ派構成員" },
    { id: "enemy_rei", name: "レイ" },
    { id: "enemy_tinabei", name: "ティナベイ" },
    { id: "enemy_yanan_1", name: "ヤナン・カウ（初戦）" },
    { id: "enemy_ganari", name: "ガナリ" },
    { id: "enemy_yanan_2", name: "ヤナン・カウ（二戦目）" },
    { id: "enemy_aya_normal", name: "アヤ" },
    { id: "enemy_aya_true", name: "アヤ（誠実たれ）" },
  ]);
